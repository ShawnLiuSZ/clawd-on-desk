...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      qqBot: "QQ Bot",
      qqBotDescription: "Send permission approvals and status notifications to QQ via the official QQ Bot API.",
      qqBotAppId: "AppID",
      qqBotAppSecret: "AppSecret",
      qqBotUserOpenid: "User OpenID",
      qqBotApprovalEnabled: "Remote Approval",
      qqBotApprovalEnabledDescription: "Send interactive cards to QQ for permission approvals.",
      qqBotTestConnection: "Test Connection",
      qqBotConnected: "Connected",
      qqBotDisconnected: "Disconnected",
      qqBotConfigIncomplete: "Please fill in AppID, AppSecret, and User OpenID.",
      qqBotTestSuccess: "QQ Bot connection test passed.",
      qqBotTestFailed: "QQ Bot connection test failed.",
      wechatBot: "WeChat Bot",
      wechatBotDescription: "Send permission approvals to WeChat via the ilink Bot API.",
      wechatBotToken: "Bearer Token",
      wechatBotApprovalEnabled: "Remote Approval",
      wechatBotApprovalEnabledDescription: "Send plain-text approval requests to your WeChat personal account.",
      wechatBotBaseUrl: "API Base URL",
      wechatBotAccountId: "Account ID",
      wechatBotTestConnection: "Test Connection",
      wechatBotConnected: "Connected",
      wechatBotDisconnected: "Disconnected",
      wechatBotConfigIncomplete: "Please enter your ilink Bearer Token.",
      wechatBotTestSuccess: "WeChat Bot connection test passed.",
      wechatBotTestFailed: "WeChat Bot connection test failed.",
      enableTestSection: "Enable / Test",
      buttonTesting: "Testing…",
      unknownError: "Unknown error",
      qqBotStatusNotConfigured: "Not configured — enter your AppID below.",
      qqBotStatusAppIdOnly: "AppID configured. Enter AppSecret to activate.",
      qqBotStatusConfigured: "Configured: AppID {id}…, secret is set.",
      qqBotSectionAppId: "AppID / AppSecret",
      qqBotAppIdDescription: "Your QQ Bot AppID from q.qq.com.",
      qqBotAppSecretStored: "AppSecret is configured",
      qqBotAppSecretStoredDescription: "The secret is stored locally. Click Replace to update it.",
      qqBotReplaceSecret: "Replace Secret",
      qqBotAppSecretReplaceDescription: "Enter a new secret to replace the current one.",
      qqBotAppSecretDescription: "Your QQ Bot AppSecret from q.qq.com.",
      qqBotSecretPlaceholderKeep: "Leave blank to keep current",
      qqBotSecretPlaceholderNew: "Paste AppSecret here",
      qqBotEnabledLabel: "Enabled",
      qqBotEnabledDescription: "Enable QQ Bot for remote approval.",
      qqBotOpenidConfigured: "OpenID is configured.",
      qqBotOpenidDescription: "Auto-discovered when you message the bot via QQ, or enter manually.",
      qqBotOpenidPlaceholder: "Paste OpenID or leave blank",
      qqBotTestDescription: "Send the bot a C2C message first to auto-discover your OpenID, then test the connection.",
      qqBotConfigSaved: "QQ Bot config saved.",
      wechatBotStatusNotConfigured: "Not configured — login via QR code or paste your Bearer token below.",
      wechatBotStatusConfigured: "Token configured. Ready to receive approval requests.",
      wechatBotTokenStored: "Token is configured",
      wechatBotTokenStoredDescription: "Your ilink Bearer token is stored locally. Click Replace to update it.",
      wechatBotReplaceToken: "Replace Token",
      wechatBotTokenReplaceDescription: "Enter a new token to replace the current one.",
      wechatBotTokenDescription: "Paste your ilink Bearer token, or login via QR code below.",
      wechatBotTokenPlaceholderKeep: "Leave blank to keep current",
      wechatBotTokenPlaceholderNew: "Paste ilink Bearer token",
      wechatBotQrLogin: "Login with QR Code",
      wechatBotQrReplaceScan: "Scan to replace your current token.",
      wechatBotQrReplaceGenerate: "Generate a new QR code to replace your current token.",
      wechatBotQrLoginScan: "Scan the QR code with WeChat to login.",
      wechatBotQrLoginGenerate: "Click the button below to generate a WeChat login QR code.",
      wechatBotQrScanHint: "Scan the QR code with WeChat on your phone to login.",
      wechatBotQrImageAlt: "WeChat Login QR Code",
      wechatBotGeneratingQr: "Generating QR code…",
      wechatBotGetQr: "Get QR Code",
      wechatBotCancelQrLogin: "Cancel QR Login",
      wechatBotGetQrFailed: "Failed to get QR code",
      wechatBotQrError: "QR code expired or login failed",
      wechatBotQrTimeout: "QR code expired. Please generate a new one.",
      wechatBotLoginSuccess: "WeChat login successful!",
      wechatBotEnabledLabel: "Enabled",
      wechatBotTestDescription: "Verify that the WeChat Bot can connect to the ilink gateway.",
      wechatBotConfigSaved: "WeChat Bot config saved.",
      ...
      larkBotTesting: "Testing…",
      larkBotBoundChat: "Bound chat",
      larkBotBindStatusWaiting: "Send any message to your bot in Feishu/Lark to bind a chat.",
      larkBotRebind: "Rebind",
      // ── Lark/Feishu bot (ported from src/i18n.js) ──
      save: "Save",
      cancel: "Cancel",
      retry: "Retry",
      required: "is required",
      toastSaveSuccess: "Saved.",
      larkBot: "Lark/Feishu Bot",
      larkBotDescription: "Send permission approvals and status notifications to Lark or Feishu",
      larkBotRegion: "Region",
      larkBotRegionFeishu: "Feishu (飞书) - China",
      larkBotRegionLark: "Lark - International",
      larkBotRegionDescription: "Select the platform to use. Feishu for China, Lark for international users.",
      larkBotAppId: "App ID",
      larkBotAppSecret: "App Secret",
      larkBotChatId: "Chat ID",
      larkBotChatIdDescription: "Target chat ID (for group chats) or user Open ID (for private messages)",
      larkBotApprovalEnabled: "Remote Approval",
      larkBotApprovalEnabledDescription: "Send interactive cards for permission approvals",
      larkBotTestConnection: "Test Connection",
      larkBotConnected: "Connected",
      larkBotDisconnected: "Disconnected",
      larkBotAuthMode: "Auth Mode",
      larkBotAuthModeAppSecret: "App Secret",
      larkBotAuthModeDeviceCode: "Scan to Connect (Device Code)",
      larkBotConnectDevice: "Connect with Feishu/Lark",
      larkBotScanQRCode: "Scan QR Code",
      larkBotEnterCode: "Or enter the code",
      larkBotDeviceAuthWaiting: "Waiting for scan...",
      larkBotDeviceAuthSuccess: "Authorization successful",
      larkBotDeviceAuthExpired: "QR code expired, please retry",
      larkBotDeviceAuthDenied: "Authorization denied",
      larkBotDeviceAuthConnectedUser: "Connected User",
      larkBotDeviceAuthStatusConnected: "Connected as",
      larkBotDeviceAuthDisconnect: "Disconnect",
      larkBotDeviceAuthAutoPopulated: "Auto-populated via device code authorization",
    ...
    zh: {
      ...
      qqBot: "QQ 机器人",
      qqBotDescription: "通过 QQ 官方机器人 API 发送权限审批和状态通知。",
      qqBotAppId: "AppID",
      qqBotAppSecret: "AppSecret",
      qqBotUserOpenid: "用户 OpenID",
      qqBotApprovalEnabled: "远程审批",
      qqBotApprovalEnabledDescription: "发送交互卡片到 QQ 进行权限审批。",
      qqBotTestConnection: "测试连接",
      qqBotConnected: "已连接",
      qqBotDisconnected: "未连接",
      qqBotConfigIncomplete: "请填写 AppID、AppSecret 和用户 OpenID。",
      qqBotTestSuccess: "QQ 机器人连接测试通过。",
      qqBotTestFailed: "QQ 机器人连接测试失败。",
      wechatBot: "微信机器人",
      wechatBotDescription: "通过 ilink Bot API 发送权限审批到微信。",
      wechatBotToken: "Bearer Token",
      wechatBotApprovalEnabled: "远程审批",
      wechatBotApprovalEnabledDescription: "发送纯文本审批请求到你的微信个人号。",
      wechatBotBaseUrl: "API 地址",
      wechatBotAccountId: "账户 ID",
      wechatBotTestConnection: "测试连接",
      wechatBotConnected: "已连接",
      wechatBotDisconnected: "未连接",
      wechatBotConfigIncomplete: "请输入 ilink Bearer Token。",
      wechatBotTestSuccess: "微信机器人连接测试通过。",
      wechatBotTestFailed: "微信机器人连接测试失败。",
      enableTestSection: "启用 / 测试",
      buttonTesting: "测试中…",
      unknownError: "未知错误",
      qqBotStatusNotConfigured: "尚未配置 —— 请在下方填写 AppID。",
      qqBotStatusAppIdOnly: "已填写 AppID，请填写 AppSecret 以激活。",
      qqBotStatusConfigured: "已配置：AppID {id}…，密钥已设置。",
      qqBotSectionAppId: "AppID / AppSecret",
      qqBotAppIdDescription: "你在 q.qq.com 获取的 QQ 机器人 AppID。",
      qqBotAppSecretStored: "AppSecret 已配置",
      qqBotAppSecretStoredDescription: "密钥已保存在本地，点击「替换」可更新。",
      qqBotReplaceSecret: "替换密钥",
      qqBotAppSecretReplaceDescription: "输入新密钥以替换当前密钥。",
      qqBotAppSecretDescription: "你在 q.qq.com 获取的 QQ 机器人 AppSecret。",
      qqBotSecretPlaceholderKeep: "留空则保持当前值",
      qqBotSecretPlaceholderNew: "在此粘贴 AppSecret",
      qqBotEnabledLabel: "启用",
      qqBotEnabledDescription: "启用 QQ 机器人进行远程审批。",
      qqBotOpenidConfigured: "OpenID 已配置。",
      qqBotOpenidDescription: "通过 QQ 向机器人发消息后自动获取，或手动输入。",
      qqBotOpenidPlaceholder: "粘贴 OpenID，或留空",
      qqBotTestDescription: "请先通过 QQ 给机器人发一条 C2C 消息以自动获取 OpenID，然后测试连接。",
      qqBotConfigSaved: "QQ 机器人配置已保存。",
      wechatBotStatusNotConfigured: "尚未配置 —— 请通过二维码登录，或在下方粘贴 Bearer Token。",
      wechatBotStatusConfigured: "Token 已配置，可以接收审批请求。",
      wechatBotTokenStored: "Token 已配置",
      wechatBotTokenStoredDescription: "你的 ilink Bearer Token 已保存在本地，点击「替换」可更新。",
      wechatBotReplaceToken: "替换 Token",
      wechatBotTokenReplaceDescription: "输入新 Token 以替换当前 Token。",
      wechatBotTokenDescription: "粘贴你的 ilink Bearer Token，或通过下方二维码登录。",
      wechatBotTokenPlaceholderKeep: "留空则保持当前值",
      wechatBotTokenPlaceholderNew: "粘贴 ilink Bearer Token",
      wechatBotQrLogin: "二维码登录",
      wechatBotQrReplaceScan: "扫码以替换当前 Token。",
      wechatBotQrReplaceGenerate: "生成新二维码以替换当前 Token。",
      wechatBotQrLoginScan: "用微信扫描二维码登录。",
      wechatBotQrLoginGenerate: "点击下方按钮生成微信登录二维码。",
      wechatBotQrScanHint: "用手机微信扫描二维码登录。",
      wechatBotQrImageAlt: "微信登录二维码",
      wechatBotGeneratingQr: "正在生成二维码…",
      wechatBotGetQr: "获取二维码",
      wechatBotCancelQrLogin: "取消二维码登录",
      wechatBotGetQrFailed: "获取二维码失败",
      wechatBotQrError: "二维码已过期或登录失败",
      wechatBotQrTimeout: "二维码已过期，请重新生成。",
      wechatBotLoginSuccess: "微信登录成功！",
      wechatBotEnabledLabel: "启用",
      wechatBotTestDescription: "验证微信机器人能否连接到 ilink 网关。",
      wechatBotConfigSaved: "微信机器人配置已保存。",
      ...
      larkBotTesting: "测试中…",
      larkBotBoundChat: "已绑定会话",
      larkBotBindStatusWaiting: "在飞书/Lark 里给机器人发送任意消息以绑定会话。",
      larkBotRebind: "重新绑定",
      // ── Lark/Feishu bot (ported from src/i18n.js) ──
      save: "保存",
      cancel: "取消",
      ...
      larkBot: "飞书/Lark 机器人",
      larkBotDescription: "发送权限审批和状态通知到飞书或 Lark",
      larkBotRegion: "地区",
      larkBotRegionFeishu: "飞书 - 中国",
      larkBotRegionLark: "Lark - 国际",
      larkBotRegionDescription: "选择使用的平台。中国用户使用飞书，国际用户使用 Lark。",
      larkBotAppId: "App ID",
      larkBotAppSecret: "App Secret",
      larkBotChatId: "Chat ID",
      larkBotChatIdDescription: "目标群聊 ID（群聊）或用户 Open ID（私聊）",
      larkBotApprovalEnabled: "远程审批",
      larkBotApprovalEnabledDescription: "发送交互卡片进行权限审批",
      larkBotTestConnection: "测试连接",
      larkBotConnected: "已连接",
      larkBotDisconnected: "未连接",
      larkBotAuthMode: "认证模式",
      larkBotAuthModeAppSecret: "App Secret",
      larkBotAuthModeDeviceCode: "扫码连接（设备码）",
      larkBotConnectDevice: "连接飞书/Lark",
      larkBotScanQRCode: "扫码连接",
      larkBotEnterCode: "或在浏览器输入验证码",
      larkBotDeviceAuthWaiting: "等待扫码中...",
      larkBotDeviceAuthSuccess: "授权成功",
      larkBotDeviceAuthExpired: "二维码已过期，请重试",
      larkBotDeviceAuthDenied: "已拒绝授权",
      larkBotDeviceAuthConnectedUser: "已连接用户",
      larkBotDeviceAuthStatusConnected: "当前已连接为",
      larkBotDeviceAuthDisconnect: "断开连接",
      larkBotDeviceAuthAutoPopulated: "通过设备码授权自动填充",
    ...
    "zh-TW": {
      ...
      telegramApprovalPrereqMissingRecipient: "接收人 user id",
      qqBot: "QQ 機器人",
      qqBotDescription: "透過 QQ 官方機器人 API 發送權限審批和狀態通知。",
      qqBotAppId: "AppID",
      qqBotAppSecret: "AppSecret",
      qqBotUserOpenid: "使用者 OpenID",
      qqBotApprovalEnabled: "遠端審批",
      qqBotApprovalEnabledDescription: "發送互動卡片到 QQ 進行權限審批。",
      qqBotTestConnection: "測試連線",
      qqBotConnected: "已連線",
      qqBotDisconnected: "未連線",
      qqBotConfigIncomplete: "請填寫 AppID、AppSecret 和使用者 OpenID。",
      qqBotTestSuccess: "QQ 機器人連線測試通過。",
      qqBotTestFailed: "QQ 機器人連線測試失敗。",
      wechatBot: "微信機器人",
      wechatBotDescription: "透過 ilink Bot API 發送權限審批到微信。",
      wechatBotToken: "Bearer Token",
      wechatBotApprovalEnabled: "遠端審批",
      wechatBotApprovalEnabledDescription: "發送純文字審批請求到你的微信個人號。",
      wechatBotBaseUrl: "API 位址",
      wechatBotAccountId: "帳戶 ID",
      wechatBotTestConnection: "測試連線",
      wechatBotConnected: "已連線",
      wechatBotDisconnected: "未連線",
      wechatBotConfigIncomplete: "請輸入 ilink Bearer Token。",
      wechatBotTestSuccess: "微信機器人連線測試通過。",
      wechatBotTestFailed: "微信機器人連線測試失敗。",
      enableTestSection: "啟用 / 測試",
      buttonTesting: "測試中…",
      unknownError: "未知錯誤",
      qqBotStatusNotConfigured: "尚未設定 —— 請在下方填寫 AppID。",
      qqBotStatusAppIdOnly: "已填寫 AppID，請填寫 AppSecret 以啟用。",
      qqBotStatusConfigured: "已設定：AppID {id}…，金鑰已設定。",
      qqBotSectionAppId: "AppID / AppSecret",
      qqBotAppIdDescription: "你在 q.qq.com 取得的 QQ 機器人 AppID。",
      qqBotAppSecretStored: "AppSecret 已設定",
      qqBotAppSecretStoredDescription: "金鑰已儲存在本機，點擊「替換」可更新。",
      qqBotReplaceSecret: "替換金鑰",
      qqBotAppSecretReplaceDescription: "輸入新金鑰以替換目前金鑰。",
      qqBotAppSecretDescription: "你在 q.qq.com 取得的 QQ 機器人 AppSecret。",
      qqBotSecretPlaceholderKeep: "留空則保持目前值",
      qqBotSecretPlaceholderNew: "在此貼上 AppSecret",
      qqBotEnabledLabel: "啟用",
      qqBotEnabledDescription: "啟用 QQ 機器人進行遠端審批。",
      qqBotOpenidConfigured: "OpenID 已設定。",
      qqBotOpenidDescription: "透過 QQ 向機器人傳訊後自動取得，或手動輸入。",
      qqBotOpenidPlaceholder: "貼上 OpenID，或留空",
      qqBotTestDescription: "請先透過 QQ 給機器人傳一則 C2C 訊息以自動取得 OpenID，然後測試連線。",
      qqBotConfigSaved: "QQ 機器人設定已儲存。",
      wechatBotStatusNotConfigured: "尚未設定 —— 請透過 QR Code 登入，或在下方貼上 Bearer Token。",
      wechatBotStatusConfigured: "Token 已設定，可以接收審批請求。",
      wechatBotTokenStored: "Token 已設定",
      wechatBotTokenStoredDescription: "你的 ilink Bearer Token 已儲存在本機，點擊「替換」可更新。",
      wechatBotReplaceToken: "替換 Token",
      wechatBotTokenReplaceDescription: "輸入新 Token 以替換目前 Token。",
      wechatBotTokenDescription: "貼上你的 ilink Bearer Token，或透過下方 QR Code 登入。",
      wechatBotTokenPlaceholderKeep: "留空則保持目前值",
      wechatBotTokenPlaceholderNew: "貼上 ilink Bearer Token",
      wechatBotQrLogin: "QR Code 登入",
      wechatBotQrReplaceScan: "掃碼以替換目前 Token。",
      wechatBotQrReplaceGenerate: "產生新 QR Code 以替換目前 Token。",
      wechatBotQrLoginScan: "用微信掃描 QR Code 登入。",
      wechatBotQrLoginGenerate: "點擊下方按鈕產生微信登入 QR Code。",
      wechatBotQrScanHint: "用手機微信掃描 QR Code 登入。",
      wechatBotQrImageAlt: "微信登入 QR Code",
      wechatBotGeneratingQr: "正在產生 QR Code…",
      wechatBotGetQr: "取得 QR Code",
      wechatBotCancelQrLogin: "取消 QR Code 登入",
      wechatBotGetQrFailed: "取得 QR Code 失敗",
      wechatBotQrError: "QR Code 已過期或登入失敗",
      wechatBotQrTimeout: "QR Code 已過期，請重新產生。",
      wechatBotLoginSuccess: "微信登入成功！",
      wechatBotEnabledLabel: "啟用",
      wechatBotTestDescription: "驗證微信機器人能否連線到 ilink 閘道。",
      wechatBotConfigSaved: "微信機器人設定已儲存。",
      ...
      larkBotTesting: "測試中…",
      larkBotBoundChat: "已綁定會話",
      larkBotBindStatusWaiting: "在飛書/Lark 裡向機器人發送任意訊息以綁定會話。",
      larkBotRebind: "重新綁定",
      // ── Lark/Feishu bot (ported from src/i18n.js) ──
      save: "儲存",
      cancel: "取消",
      retry: "重試",
      required: "為必填項",
      toastSaveSuccess: "已儲存",
      larkBot: "飛書/Lark 機器人",
      larkBotDescription: "發送權限審批和狀態通知到飛書或 Lark",
      larkBotRegion: "地區",
      larkBotRegionFeishu: "飛書 - 中國",
      larkBotRegionLark: "Lark - 國際",
      larkBotRegionDescription: "選擇使用的平台。中國用戶使用飛書，國際用戶使用 Lark。",
      larkBotAppId: "App ID",
      larkBotAppSecret: "App Secret",
      larkBotChatId: "Chat ID",
      larkBotChatIdDescription: "目標群聊 ID（群聊）或用戶 Open ID（私聊）",
      larkBotApprovalEnabled: "遠程審批",
      larkBotApprovalEnabledDescription: "發送交互卡片進行權限審批",
      larkBotTestConnection: "測試連接",
      larkBotConnected: "已連接",
      larkBotDisconnected: "未連接",
      larkBotAuthMode: "認證模式",
      larkBotAuthModeAppSecret: "App Secret",
      larkBotAuthModeDeviceCode: "掃碼連接（裝置碼）",
      larkBotConnectDevice: "連接飛書/Lark",
      larkBotScanQRCode: "掃碼連接",
      larkBotEnterCode: "或在瀏覽器輸入驗證碼",
      larkBotDeviceAuthWaiting: "等待掃碼中...",
      larkBotDeviceAuthSuccess: "授權成功",
      larkBotDeviceAuthExpired: "二維碼已過期，請重試",
      larkBotDeviceAuthDenied: "已拒絕授權",
      larkBotDeviceAuthConnectedUser: "已連接用戶",
      larkBotDeviceAuthStatusConnected: "目前已連接為",
      larkBotDeviceAuthDisconnect: "斷開連接",
      larkBotDeviceAuthAutoPopulated: "通過裝置碼授權自動填充",
    ...
    ko: {
      ...
      qqBot: "QQ 봇",
      qqBotDescription: "QQ 공식 봇 API를 통해 권한 승인 및 상태 알림을 보냅니다.",
      qqBotAppId: "AppID",
      qqBotAppSecret: "AppSecret",
      qqBotUserOpenid: "사용자 OpenID",
      qqBotApprovalEnabled: "원격 승인",
      qqBotApprovalEnabledDescription: "QQ로 대화형 카드를 보내 권한을 승인합니다.",
      qqBotTestConnection: "연결 테스트",
      qqBotConnected: "연결됨",
      qqBotDisconnected: "연결 안 됨",
      qqBotConfigIncomplete: "AppID, AppSecret, 사용자 OpenID를 입력하세요.",
      qqBotTestSuccess: "QQ 봇 연결 테스트 통과.",
      qqBotTestFailed: "QQ 봇 연결 테스트 실패.",
      wechatBot: "위챗 봇",
      wechatBotDescription: "ilink Bot API를 통해 위챗으로 권한 승인을 보냅니다.",
      wechatBotToken: "Bearer Token",
      wechatBotApprovalEnabled: "원격 승인",
      wechatBotApprovalEnabledDescription: "위챗 개인 계정으로 일반 텍스트 승인 요청을 보냅니다.",
      wechatBotBaseUrl: "API 주소",
      wechatBotAccountId: "계정 ID",
      wechatBotTestConnection: "연결 테스트",
      wechatBotConnected: "연결됨",
      wechatBotDisconnected: "연결 안 됨",
      wechatBotConfigIncomplete: "ilink Bearer Token을 입력하세요.",
      wechatBotTestSuccess: "위챗 봇 연결 테스트 통과.",
      wechatBotTestFailed: "위챗 봇 연결 테스트 실패.",
      enableTestSection: "활성화 / 테스트",
      buttonTesting: "테스트 중…",
      unknownError: "알 수 없는 오류",
      qqBotStatusNotConfigured: "설정되지 않음 — 아래에 AppID를 입력하세요.",
      qqBotStatusAppIdOnly: "AppID가 설정됨. 활성화하려면 AppSecret을 입력하세요.",
      qqBotStatusConfigured: "설정 완료: AppID {id}…, 시크릿 설정됨.",
      qqBotSectionAppId: "AppID / AppSecret",
      qqBotAppIdDescription: "q.qq.com에서 발급받은 QQ 봇 AppID입니다.",
      qqBotAppSecretStored: "AppSecret이 설정됨",
      qqBotAppSecretStoredDescription: "시크릿은 로컬에 저장됩니다. 변경하려면 교체를 클릭하세요.",
      qqBotReplaceSecret: "시크릿 교체",
      qqBotAppSecretReplaceDescription: "현재 시크릿을 교체할 새 시크릿을 입력하세요.",
      qqBotAppSecretDescription: "q.qq.com에서 발급받은 QQ 봇 AppSecret입니다.",
      qqBotSecretPlaceholderKeep: "비워 두면 현재 값을 유지합니다",
      qqBotSecretPlaceholderNew: "여기에 AppSecret을 붙여넣으세요",
      qqBotEnabledLabel: "활성화",
      qqBotEnabledDescription: "원격 승인을 위해 QQ 봇을 활성화합니다.",
      qqBotOpenidConfigured: "OpenID가 설정됨.",
      qqBotOpenidDescription: "QQ로 봇에 메시지를 보내면 자동으로 검색되거나, 직접 입력할 수 있습니다.",
      qqBotOpenidPlaceholder: "OpenID를 붙여넣거나 비워 두세요",
      qqBotTestDescription: "먼저 QQ로 봇에 C2C 메시지를 보내 OpenID를 자동 검색한 뒤 연결을 테스트하세요.",
      qqBotConfigSaved: "QQ 봇 설정이 저장되었습니다.",
      wechatBotStatusNotConfigured: "설정되지 않음 — QR 코드로 로그인하거나 아래에 Bearer 토큰을 붙여넣으세요.",
      wechatBotStatusConfigured: "토큰이 설정됨. 승인 요청을 받을 준비가 되었습니다.",
      wechatBotTokenStored: "토큰이 설정됨",
      wechatBotTokenStoredDescription: "ilink Bearer 토큰은 로컬에 저장됩니다. 변경하려면 교체를 클릭하세요.",
      wechatBotReplaceToken: "토큰 교체",
      wechatBotTokenReplaceDescription: "현재 토큰을 교체할 새 토큰을 입력하세요.",
      wechatBotTokenDescription: "ilink Bearer 토큰을 붙여넣거나 아래 QR 코드로 로그인하세요.",
      wechatBotTokenPlaceholderKeep: "비워 두면 현재 값을 유지합니다",
      wechatBotTokenPlaceholderNew: "ilink Bearer 토큰 붙여넣기",
      wechatBotQrLogin: "QR 코드로 로그인",
      wechatBotQrReplaceScan: "현재 토큰을 교체하려면 스캔하세요.",
      wechatBotQrReplaceGenerate: "현재 토큰을 교체할 새 QR 코드를 생성하세요.",
      wechatBotQrLoginScan: "위챗으로 QR 코드를 스캔하여 로그인하세요.",
      wechatBotQrLoginGenerate: "아래 버튼을 클릭하여 위챗 로그인 QR 코드를 생성하세요.",
      wechatBotQrScanHint: "휴대폰의 위챗으로 QR 코드를 스캔하여 로그인하세요.",
      wechatBotQrImageAlt: "위챗 로그인 QR 코드",
      wechatBotGeneratingQr: "QR 코드 생성 중…",
      wechatBotGetQr: "QR 코드 가져오기",
      wechatBotCancelQrLogin: "QR 로그인 취소",
      wechatBotGetQrFailed: "QR 코드를 가져오지 못했습니다",
      wechatBotQrError: "QR 코드가 만료되었거나 로그인에 실패했습니다",
      wechatBotQrTimeout: "QR 코드가 만료되었습니다. 새로 생성하세요.",
      wechatBotLoginSuccess: "위챗 로그인 성공!",
      wechatBotEnabledLabel: "활성화",
      wechatBotTestDescription: "위챗 봇이 ilink 게이트웨이에 연결할 수 있는지 확인합니다.",
      wechatBotConfigSaved: "위챗 봇 설정이 저장되었습니다.",
      ...
      larkBotTesting: "테스트 중…",
      larkBotBoundChat: "연결된 채팅",
      larkBotBindStatusWaiting: "Feishu/Lark에서 봇에게 아무 메시지나 보내 채팅을 연결하세요.",
      larkBotRebind: "다시 연결",
      // ── Lark/Feishu bot (ported from src/i18n.js) ──
      save: "저장",
      cancel: "취소",
      retry: "다시 시도",
      required: "은(는) 필수입니다",
      toastSaveSuccess: "저장되었습니다",
      larkBot: "Lark/Feishu 봇",
      larkBotDescription: "Lark 또는 Feishu에 권한 승인 및 상태 알림을 보냅니다",
      larkBotRegion: "지역",
      larkBotRegionFeishu: "Feishu (飞书) - 중국",
      larkBotRegionLark: "Lark - 국제",
      larkBotRegionDescription: "사용할 플랫폼을 선택하세요. 중국 사용자는 Feishu, 국제 사용자는 Lark를 사용합니다.",
      larkBotAppId: "App ID",
      larkBotAppSecret: "App Secret",
      larkBotChatId: "Chat ID",
      larkBotChatIdDescription: "대상 채팅 ID (그룹 채팅) 또는 사용자 Open ID (개인 메시지)",
      larkBotApprovalEnabled: "원격 승인",
      larkBotApprovalEnabledDescription: "권한 승인을 위한 인터랙티브 카드를 보냅니다",
      larkBotTestConnection: "연결 테스트",
      larkBotConnected: "연결됨",
      larkBotDisconnected: "연결 끊김",
      larkBotAuthMode: "인증 모드",
      larkBotAuthModeAppSecret: "App Secret",
      larkBotAuthModeDeviceCode: "QR 코드 연결 (기기 코드)",
      larkBotConnectDevice: "Feishu/Lark에 연결",
      larkBotScanQRCode: "QR 코드 스캔",
      larkBotEnterCode: "또는 브라우저에서 코드 입력",
      larkBotDeviceAuthWaiting: "스캔 대기 중...",
      larkBotDeviceAuthSuccess: "인증 성공",
      larkBotDeviceAuthExpired: "QR 코드 만료, 다시 시도하세요",
      larkBotDeviceAuthDenied: "인증 거부됨",
      larkBotDeviceAuthConnectedUser: "연결된 사용자",
      larkBotDeviceAuthStatusConnected: "다음으로 연결됨",
      larkBotDeviceAuthDisconnect: "연결 끊기",
      larkBotDeviceAuthAutoPopulated: "기기 코드 인증을 통해 자동 채워짐",
    ...
    ja: {
      ...
      qqBot: "QQ ボット",
      qqBotDescription: "QQ 公式ボット API を通じて権限承認とステータス通知を送信します。",
      qqBotAppId: "AppID",
      qqBotAppSecret: "AppSecret",
      qqBotUserOpenid: "ユーザー OpenID",
      qqBotApprovalEnabled: "リモート承認",
      qqBotApprovalEnabledDescription: "QQ にインタラクティブカードを送信して権限を承認します。",
      qqBotTestConnection: "接続テスト",
      qqBotConnected: "接続済み",
      qqBotDisconnected: "未接続",
      qqBotConfigIncomplete: "AppID、AppSecret、ユーザー OpenID を入力してください。",
      qqBotTestSuccess: "QQ ボット接続テスト成功。",
      qqBotTestFailed: "QQ ボット接続テスト失敗。",
      wechatBot: "WeChat ボット",
      wechatBotDescription: "ilink Bot API を通じて WeChat に権限承認を送信します。",
      wechatBotToken: "Bearer Token",
      wechatBotApprovalEnabled: "リモート承認",
      wechatBotApprovalEnabledDescription: "WeChat 個人アカウントにプレーンテキストの承認リクエストを送信します。",
      wechatBotBaseUrl: "API アドレス",
      wechatBotAccountId: "アカウント ID",
      wechatBotTestConnection: "接続テスト",
      wechatBotConnected: "接続済み",
      wechatBotDisconnected: "未接続",
      wechatBotConfigIncomplete: "ilink Bearer Token を入力してください。",
      wechatBotTestSuccess: "WeChat ボット接続テスト成功。",
      wechatBotTestFailed: "WeChat ボット接続テスト失敗。",
      enableTestSection: "有効化 / テスト",
      buttonTesting: "テスト中…",
      unknownError: "不明なエラー",
      qqBotStatusNotConfigured: "未設定 —— 下に AppID を入力してください。",
      qqBotStatusAppIdOnly: "AppID を設定済み。有効化するには AppSecret を入力してください。",
      qqBotStatusConfigured: "設定済み：AppID {id}…、シークレット設定済み。",
      qqBotSectionAppId: "AppID / AppSecret",
      qqBotAppIdDescription: "q.qq.com で取得した QQ ボットの AppID です。",
      qqBotAppSecretStored: "AppSecret は設定済み",
      qqBotAppSecretStoredDescription: "シークレットはローカルに保存されます。変更するには「置き換え」をクリックしてください。",
      qqBotReplaceSecret: "シークレットを置き換え",
      qqBotAppSecretReplaceDescription: "現在のシークレットを置き換える新しいシークレットを入力してください。",
      qqBotAppSecretDescription: "q.qq.com で取得した QQ ボットの AppSecret です。",
      qqBotSecretPlaceholderKeep: "空欄のままにすると現在の値を保持します",
      qqBotSecretPlaceholderNew: "ここに AppSecret を貼り付け",
      qqBotEnabledLabel: "有効",
      qqBotEnabledDescription: "リモート承認のために QQ ボットを有効にします。",
      qqBotOpenidConfigured: "OpenID は設定済み。",
      qqBotOpenidDescription: "QQ でボットにメッセージを送ると自動的に検出されます。手動入力も可能です。",
      qqBotOpenidPlaceholder: "OpenID を貼り付けるか空欄のまま",
      qqBotTestDescription: "まず QQ でボットに C2C メッセージを送って OpenID を自動検出してから、接続をテストしてください。",
      qqBotConfigSaved: "QQ ボットの設定を保存しました。",
      wechatBotStatusNotConfigured: "未設定 —— QR コードでログインするか、下に Bearer トークンを貼り付けてください。",
      wechatBotStatusConfigured: "トークン設定済み。承認リクエストを受信できます。",
      wechatBotTokenStored: "トークンは設定済み",
      wechatBotTokenStoredDescription: "ilink Bearer トークンはローカルに保存されます。変更するには「置き換え」をクリックしてください。",
      wechatBotReplaceToken: "トークンを置き換え",
      wechatBotTokenReplaceDescription: "現在のトークンを置き換える新しいトークンを入力してください。",
      wechatBotTokenDescription: "ilink Bearer トークンを貼り付けるか、下の QR コードでログインしてください。",
      wechatBotTokenPlaceholderKeep: "空欄のままにすると現在の値を保持します",
      wechatBotTokenPlaceholderNew: "ilink Bearer トークンを貼り付け",
      wechatBotQrLogin: "QR コードでログイン",
      wechatBotQrReplaceScan: "現在のトークンを置き換えるにはスキャンしてください。",
      wechatBotQrReplaceGenerate: "現在のトークンを置き換える新しい QR コードを生成してください。",
      wechatBotQrLoginScan: "WeChat で QR コードをスキャンしてログインしてください。",
      wechatBotQrLoginGenerate: "下のボタンをクリックして WeChat ログイン QR コードを生成してください。",
      wechatBotQrScanHint: "スマホの WeChat で QR コードをスキャンしてログインしてください。",
      wechatBotQrImageAlt: "WeChat ログイン QR コード",
      wechatBotGeneratingQr: "QR コードを生成中…",
      wechatBotGetQr: "QR コードを取得",
      wechatBotCancelQrLogin: "QR ログインをキャンセル",
      wechatBotGetQrFailed: "QR コードの取得に失敗しました",
      wechatBotQrError: "QR コードの有効期限が切れたか、ログインに失敗しました",
      wechatBotQrTimeout: "QR コードの有効期限が切れました。新しく生成してください。",
      wechatBotLoginSuccess: "WeChat ログイン成功！",
      wechatBotEnabledLabel: "有効",
      wechatBotTestDescription: "WeChat ボットが ilink ゲートウェイに接続できるか確認します。",
      wechatBotConfigSaved: "WeChat ボットの設定を保存しました。",
      ...
      larkBotTesting: "テスト中…",
      larkBotBoundChat: "バインド済みチャット",
      larkBotBindStatusWaiting: "Feishu/Lark でボットにメッセージを送信してチャットをバインドします。",
      larkBotRebind: "再バインド",
      // ── Lark/Feishu bot (ported from src/i18n.js) ──
      save: "保存",
      cancel: "キャンセル",
      ...
      larkBot: "Lark/Feishu ボット",
      larkBotDescription: "LarkまたはFeishuに権限承認とステータス通知を送信します",
      larkBotRegion: "リージョン",
      larkBotRegionFeishu: "Feishu (飞书) - 中国",
      larkBotRegionLark: "Lark - 国際",
      larkBotRegionDescription: "使用するプラットフォームを選択してください。中国ユーザーはFeishu、国際ユーザーはLarkを使用します。",
      larkBotAppId: "App ID",
      larkBotAppSecret: "App Secret",
      larkBotChatId: "Chat ID",
      larkBotChatIdDescription: "ターゲットチャットID（グループチャット）またはユーザーOpen ID（ダイレクトメッセージ）",
      larkBotApprovalEnabled: "リモート承認",
      larkBotApprovalEnabledDescription: "権限承認のためにインタラクティブカードを送信します",
      larkBotTestConnection: "接続テスト",
      larkBotConnected: "接続済み",
      larkBotDisconnected: "未接続",
      larkBotAuthMode: "認証モード",
      larkBotAuthModeAppSecret: "App Secret",
      larkBotAuthModeDeviceCode: "QRコード接続（デバイスコード）",
      larkBotConnectDevice: "Feishu/Larkに接続",
      larkBotScanQRCode: "QRコードをスキャン",
      larkBotEnterCode: "またはブラウザでコードを入力",
      larkBotDeviceAuthWaiting: "スキャン待機中...",
      larkBotDeviceAuthSuccess: "認証成功",
      larkBotDeviceAuthExpired: "QRコードの有効期限切れ、再試行してください",
      larkBotDeviceAuthDenied: "認証が拒否されました",
      larkBotDeviceAuthConnectedUser: "接続ユーザー",
      larkBotDeviceAuthStatusConnected: "次のユーザーとして接続中",
      larkBotDeviceAuthDisconnect: "切断",
      larkBotDeviceAuthAutoPopulated: "デバイスコード認証により自動入力",
