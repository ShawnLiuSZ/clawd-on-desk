...
const LARK_CARD_STRINGS = {
  en: {
    ...
    elicitTitle: "Question",
    elicitNeedAll: "Pick an option for every question",
    elicitHint: "Tap to toggle, then Submit",
  ...
  zh: {
    ...
    submitDone: "完成 (已选 {n})",
    elicitTitle: "请选择",
    elicitNeedAll: "每道题至少选一个",
    elicitHint: "点按钮切换，选好后点提交",
  ...
  "zh-TW": {
    ...
    submitDone: "完成 (已選 {n})",
    elicitTitle: "請選擇",
    elicitNeedAll: "每題至少選一個",
    elicitHint: "點按鈕切換，選好後點提交",
  ...
  ko: {
    ...
    elicitTitle: "질문",
    elicitNeedAll: "각 질문에 하나 이상 선택하세요",
    elicitHint: "탭하여 선택 후 제출",
  ...
  ja: {
    ...
    submitDone: "完了 ({n}個選択)",
    elicitTitle: "質問",
    elicitNeedAll: "各質問に1つ以上選択してください",
    elicitHint: "タップで切替後、送信",
