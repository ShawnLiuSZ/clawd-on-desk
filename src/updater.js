...
const RELEASES_LATEST_URL = "https://github.com/ShawnLiuSZ/clawd-on-desk/releases/latest";
...
function initUpdater(ctx, deps = {}) {
  ...
  function fetchLatestReleaseViaRedirect() {
    return new Promise((resolve, reject) => {
      const req = httpsGet({
        hostname: "github.com",
        path: "/ShawnLiuSZ/clawd-on-desk/releases/latest",
        headers: {
  ...
  function fetchLatestReleaseFromApi() {
    return new Promise((resolve, reject) => {
      ...
      const req = httpsGet({
        ...
        path: "/repos/ShawnLiuSZ/clawd-on-desk/releases/latest",
        headers,
      }, (res) => {
